...
ADD FOREIGN KEY (id_pracownika) REFERENCES godziny(id_godziny);

ALTER TABLE godziny
ADD FOREIGN KEY (id_godziny) REFERENCES pensje(id_pensji);

ALTER TABLE pensje
ADD FOREIGN KEY (id_pensji) REFERENCES premie(id_premii);
...
SELECT DATEPART(month, 'data') AS DatePartInt;
SELECT DATEPART(day, 'data') AS DatePartInt;
